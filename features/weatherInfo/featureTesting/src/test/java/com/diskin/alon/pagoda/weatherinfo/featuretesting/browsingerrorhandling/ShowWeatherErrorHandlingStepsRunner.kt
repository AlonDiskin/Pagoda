...
@MediumTest
class ShowWeatherErrorHandlingStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        hiltRule.inject()
        start(ShowWeatherErrorHandlingSteps(locationProvider,mockWebServer,unitPrefProvider))
    }
