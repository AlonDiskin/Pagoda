...
import com.diskin.alon.pagoda.locations.presentation.model.UnBookmarkLocationModelRequest
import com.diskin.alon.pagoda.locations.presentation.model.BookmarkedLocationsModelRequest
...
class BookmarkedLocationsViewModelTest {
    ...
    fun observeModelSavedLocationsWhenCreated() {
        ...
        // When
        val paging: PagingData<UiBookmarkedLocation> = PagingData.from(emptyList())
