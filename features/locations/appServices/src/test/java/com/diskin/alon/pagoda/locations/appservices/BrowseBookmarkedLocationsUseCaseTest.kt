...
/**
 * [BrowseBookmarkdLocationsUseCase] unit test class.
 */
class BrowseBookmarkedLocationsUseCaseTest {

    // Test subject
    private lateinit var useCas: BrowseBookmarkdLocationsUseCase
    ...
    @Before
    fun setUp() {
        useCas = BrowseBookmarkdLocationsUseCase(repository, mapper)
    }
