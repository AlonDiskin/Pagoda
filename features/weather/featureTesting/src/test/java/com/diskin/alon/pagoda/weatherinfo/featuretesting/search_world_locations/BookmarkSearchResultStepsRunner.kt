...
/**
 * Step definitions runner for 'User bookmark location result' scenario.
 */
@HiltAndroidTest
...
@MediumTest
class BookmarkSearchResultStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                ...
                .withTags("@bookmark-search-result")
                .scenarios()
    ...
    fun test() {
        ...
        // Start test
        start(BookmarkSearchResultSteps(db))
    }
}