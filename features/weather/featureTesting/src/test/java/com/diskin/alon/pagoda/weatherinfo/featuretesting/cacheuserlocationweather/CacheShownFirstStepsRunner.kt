...
/**
 * Step definitions runner for 'Latest cached data shown before updated' scenario.
 */
@HiltAndroidTest
...
@MediumTest
class CacheShownFirstStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        ...
        // Start test
        start(
            CacheShownFirstSteps(mockWebServer,
                db,
                locationProvider,
