...
/**
 * Step definitions runner for 'Latest weather shown for user location' scenario.
 */
@HiltAndroidTest
...
@MediumTest
class LatestWeatherShownStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        ...
        // Start test
        start(
            LatestWeatherShownSteps(mockWebServer,
                db,
                locationProvider,
