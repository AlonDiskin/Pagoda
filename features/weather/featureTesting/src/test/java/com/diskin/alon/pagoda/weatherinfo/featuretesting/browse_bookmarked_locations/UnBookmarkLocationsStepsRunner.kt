...
/**
 * Step definitions runner for 'User unbookmark locations' scenario.
 */
@HiltAndroidTest
...
@MediumTest
class UnBookmarkLocationsStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
