...
/**
 * Step definitions runner for 'Weather cache update fail' scenario.
 */
@HiltAndroidTest
...
@MediumTest
class CacheUpdateFailStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        ...
        // Start test
        start(
            CacheUpdateFailSteps(mockWebServer,
                db,
                locationProvider,
