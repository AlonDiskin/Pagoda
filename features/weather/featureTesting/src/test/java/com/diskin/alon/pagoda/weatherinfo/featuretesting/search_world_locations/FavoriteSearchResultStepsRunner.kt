...
/**
 * Step definitions runner for 'User favorite location search result' scenario.
 */
@HiltAndroidTest
...
@MediumTest
class FavoriteSearchResultStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                .withFeatureFromAssets("feature/search_world_locations.feature")
                .withTags("@favorite-search-result")
                .scenarios()
    ...
    fun test() {
        ...
        // Start test
        start(FavoriteSearchResultSteps(db))
    }
}