...
import com.diskin.alon.pagoda.weatherinfo.presentation.databinding.BookmarkedLocationBinding
...
) : PagingDataAdapter<UiBookmarkedLocation, BookmarkedLocationsAdapter.BookmarkedLocationViewHolder>(
    DIFF_CALLBACK
) {
