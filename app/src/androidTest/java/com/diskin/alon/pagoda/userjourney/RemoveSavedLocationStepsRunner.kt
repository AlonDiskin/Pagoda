...
/**
 * Step definitions runner for 'User remove saved location' scenario.
 */
@HiltAndroidTest
@UninstallModules(SettingsNetworkingModule::class,WeatherNetworkingModule::class,AppDataModule::class)
@RunWith(Parameterized::class)
@LargeTest
class RemoveSavedLocationStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun scenarios(): Iterable<ScenarioConfig> {
            return GreenCoffeeConfig()
                .withFeatureFromAssets("assets/feature/remove_saved_world_location.feature")
                .scenarios()
        }
    }
    ...
    fun test() {
        hiltRule.inject()
        start(RemovedSavedLocationSteps(NetworkUtil.server,db))
    }
}